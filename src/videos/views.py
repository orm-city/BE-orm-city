...
from .schema import (
    ...
    video_create_schema,
    video_update_schema,
    video_destroy_schema,
    complete_upload_schema, 
    update_user_progress_schema, 
)
...
@extend_schema_view(
    list=video_list_schema,
    retrieve=video_retrieve_schema,
    create=video_create_schema,
    update=video_update_schema,
    destroy=video_destroy_schema,
)
